...
# Usage: sh check_i3knx.sh [--quality]
...
LOG_FILE="$LOG_DIR/cloud_i3knx_${HOST_LABEL}_${TIMESTAMP}_$$.log"

# Open File Descriptor 3 for technical log
if ! exec 3>>"$LOG_FILE" 2>/dev/null; then
  LOG_FILE="${TMPDIR:-/tmp}/cloud_i3knx_${HOST_LABEL}_${TIMESTAMP}_$$.log"
