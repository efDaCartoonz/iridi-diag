...
# Standalone iRidi Pro EU cloud diagnostic.
# Usage: sh check_iridi_pro_eu.sh [--quality]
...
LOG_FILE="$LOG_DIR/cloud_iridi_pro_eu_${HOST_LABEL}_${TIMESTAMP}_$$.log"

# Open File Descriptor 3 for technical log
if ! exec 3>>"$LOG_FILE" 2>/dev/null; then
  LOG_FILE="${TMPDIR:-/tmp}/cloud_iridi_pro_eu_${HOST_LABEL}_${TIMESTAMP}_$$.log"
...
USER_AGENT="iridi-diag/iridi-pro-eu/$TOOL_VERSION"
REGION="iRidi Pro EU"
